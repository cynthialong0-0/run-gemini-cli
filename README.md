...
-   <A NAME="__INPUT_UPLOAD_ARTIFACTS"></A><A HREF="#USER-CONTENT-__INPUT_ARTIFACTS">`UPLOAD_ARTIFACTS`</A>: _(OPTIONAL, DEFAULT: `FALSE`)_ WHETHER TO UPLOAD ARTIFACTS TO THE GITHUB ACTION.
